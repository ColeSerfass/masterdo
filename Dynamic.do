...
collapse loginid numservicesapr* numservicesmay* numservicesjun* reportweekendapr* reportweekendmay* reportweekendjun* onlinetrackmethod onlineattendapr* onlineattendmay* onlineattendjun* numscreensapr* numscreensmay* numscreensjun* paidstaffmay* paidstaffapr* paidstaffjun*, by(emailupd)
